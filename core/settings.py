...
SECRET_KEY = 'django-insecure-^k6xq31jt(96ysa^1y!n@2ev$5&29!kd@huaa_zsa7t5-fp8!+'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": _("CapitalAgro "),

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": _("CapitalAgro "),
    ...
    "welcome_sign": _("Welcome To CapitalAgro"),

    # Copyright on the footer
    "copyright": _("CapitalAgro Development Team"),
